$(document).ready(function() {
    ...
    $("header .plusWrap").click(function() {
        ...
        if ($(this).next("header .innerNav").is(":visible")) {
            $(this).next("header .innerNav").slideUp(500);
            $(this).removeClass("minusWrap");
        } 
        else {
            $(this).next("header .innerNav").slideDown(500);
    ...
    $(".servicesWrap .innerServiceWrap .servicesList .innerList ul li.showSingle").click(function(){
        $(".servicesWrap .innerServiceWrap .servicesList .innerList ul li.showSingle").removeClass("active");
    ...
    $(".partners_testimonials .testimonials .testimonialsWrap .testimonials_Slider").slick({
        dots: true,
        infinite: false,
        arrows:false,
        speed: 1000,
    ...
    $(".socialFeed_LifeAt .lifeAt .video_Main .playIcon").click(function(){
        ...
        $('.videoPopupWrapper .popupVideo #iframeVideo').html('<iframe src="https://www.youtube.com/embed/' + videoUrl + '?autoplay=1&rel=0" frameborder="0" allowfullscreen></iframe>');
    });
