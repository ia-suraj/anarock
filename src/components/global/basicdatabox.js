  ...
  render() {
    ...
    return (
      <div class={_myClasses}>
        {_imgsrc.length > 0 && <img src={_imgsrc} class="img-responsive" />}
        {_date.length > 0 && <div class="h8 c-basic-data-date">{_date}</div>}
        {_propertyheadingPurple.length > 0 && (
          <h2 class="h2 c-basic-data-heading-purple">
            {_propertyheadingPurple}
          </h2>
        )}
        {_propertyheadingblack.length > 0 && (
          <h2 class="h2 c-basic-data-heading-black">{_propertyheadingblack}</h2>
        )}
        {_lineone.length > 0 && (
          <div class="h7 c-basic-data-line-one">{_lineone}</div>
        )}
        {_linetwo.length > 0 && (
          <div class="h7 c-basic-data-line-two">{_linetwo}</div>
        )}
        <div class="clearfix" />
        {_ctalink.length > 0 && (
